...
namespace BiddingService.Controllers
{
    ...
    public class BidsController: ControllerBase
    {
        ...
        public BidsController(IPublishEndpoint publishEndpoint, IMapper mapper,GrpcAuctionClient grpcAuctionClient)
        {
        ...
        public async Task<ActionResult<BidDto>> PlaceBid(string auctionId, int amount)
        {
            ...
            await _publishEndpoint.Publish(_mapper.Map<BidPlaces>(bid));
